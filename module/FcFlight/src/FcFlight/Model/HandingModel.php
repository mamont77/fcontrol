 ...
 */
class HandingModel extends AbstractTableGateway
{

    /**
     * @var string
     */
    protected $table = 'flightHandingForm';
    ...
    public function __construct(Adapter $adapter)
    {
        ...
        $this->resultSetPrototype->setArrayObjectPrototype(new HandingFilter($this->adapter));
        $this->initialize();
    }
    ...
    /**
     * @param HandingFilter $object
     * @return array
     */
    public function add(HandingFilter $object)
    {
        $data = array(
     ...
     * @throws \Exception
     */
    public function save(HandingFilter $object)
    {
        $data = array(
            'headerId' => (int)$object->headerId,
            'airportId' => (int)$object->airportId,
...
//            \Zend\Debug\Debug::dump($row);
     ...
     * @return mixed
     */
    public function getHeaderRefNumberOrderByHandingId($id)
    {
        $row = $this->get($id);
